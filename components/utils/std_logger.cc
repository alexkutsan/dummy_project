...
std::string suverity(LogLevel l) {
  ...
  convert_map[LogLevel::TRACE] = "trace";
  convert_map[LogLevel::DEBUG] = "debug";
  convert_map[LogLevel::INFO] = "info";
  convert_map[LogLevel::WARNIGN] = "warn";
  convert_map[LogLevel::ERROR] = "error";
